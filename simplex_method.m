...
%% To input parameters
C=[3/4 -20 1/2 -6];
Aa=[1/4 -8 -1 9;1/2 -12 -1/6 3;0 0 1 0];
b=[0;0;1];
Variables=size(Aa,2);
s=eye(size(Aa,1));
A=[Aa s b];
...
%To print the table
ZCj=[ZjCj; A];
SimpTable=array2table(ZCj,'VariableNames',{'x_4','x_5','x_6','x_7','s_1','s_2','s_3','Sol'}) %make table
...
%To print the updated table
    ZCj=[ZjCj;A];
    SimpTable=array2table(ZCj,'VariableNames',{'x_4','x_5','x_6','x_7','s_1','s_2','s_3','Sol'})
    BFS=zeros(1,size(A,2));
    BFS(BV)=A(:,end);
    BFS(end)=sum(BFS.*Cost);
    BFS(end)=BFS(end)*-1;
    CurrentBFS=array2table(BFS,'VariableNames',{'x_4','x_5','x_6','x_7','s_1','s_2','s_3','Sol'})
else
    Run=false
